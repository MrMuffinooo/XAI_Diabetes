...
diabetes_train_NA <- diabetes_NA[m,]
diabetes_test_NA <- diabetes_NA[-m,]
```
...
#test
diabetes_test_skip<-diabetes_test_NA[,-c(3,4,5)]
...
samp <- sample(1:231, 5)
explainer <- explain(id= 'ranger', model = model_random_skip_ranger,
