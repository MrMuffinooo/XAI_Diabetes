...
pred_test <- predict(model_ada, newdata = diabetes_test)$data$prob.0
roc <- roc(diabetes_test$class, pred_test)
cat(paste("Ada","AUC:",roc$auc, sep="\t\t"))


pred_test <- predict(model_binomial, newdata = diabetes_test)$data$prob.0
roc <- roc(diabetes_test$class, pred_test)
cat(paste("Binomial","AUC:",roc$auc, sep="\t\t"))


pred_test <- predict(model_gbm, newdata = diabetes_test)$data$prob.0
roc <- roc(diabetes_test$class, pred_test)
cat(paste("GBM","AUC:",roc$auc, sep="\t\t"))


pred_test <- predict(model_naiveBayes, newdata = diabetes_test)$data$prob.0
roc <- roc(diabetes_test$class, pred_test)
cat(paste("Naive Bayes","AUC:",roc$auc, sep="\t\t"))


pred_test <- predict(model_rForest, newdata = diabetes_test)$data$prob.0
roc <- roc(diabetes_test$class, pred_test)
cat(paste("Random forest","AUC:",roc$auc, sep="\t\t"))
