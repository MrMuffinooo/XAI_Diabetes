...
- `mice` - base dataset with all missing values imputed with mice package using PMM method. Mice is suitable for this dataset, since the values are missing at random. 
