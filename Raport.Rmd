...
![Break Down algorythm](./images/break_down_distr.png "Break Down algorythm")
...
![Break Down ordering impact](./images/ordering.png "Break Down ordering")
...
![Break Down permutations](./images/shap_10_replicates.png "Break Down permutations")
Figure: Different results of Break Down for 10 random variable orders

![Shap](./images/shap_ordering.png "Shap")
...
![Lime](./images/lime_introduction.png "Lime")
...
![Ceteris Paribus](./images/titanicCeterisProfile01E-1.png "Ceteris Paribus for different models")
Figure: Shape of lines resebles the nature of the model. Dot shows value and model's prediction for the observation.

![Ceteris Paribus](./images/titanicCeterisProfile01D-1.png "Ceteris Paribus for different observations")
...
![Feature Importance](./images/TitanicRFFeatImp10-1.png "Feature Importance for 10 permutations")
...
![Partial Dependence](./images/pdpIntuition-1.png "Ceteris Paribus and Partial Dependence relation")
...
![Partial Dependence](./images/pdpPart5-1.png "Ceteris Paribus grouped by sex")
...
### Data Original
![](./images/2-4-data-original.png)

### Data Skip
![](./images/2-4-data-skip.png)
...
- **type 1 diabetes**, where the body does not make insulin. It is mostly caused by genetic and enviromental factors
...
Gestational diabetes is the type of diabets thatdevelops during pregnancy and is caused by the hormonal changes of pregnancy along with genetic and lifestyle factors. Women with a history of gestational diabetes  have a greater chance of developing type 2 diabetes later in life.

### Comparison

The causes of diabetes according to experts directly correspond with the columns is the explained dataset:

- `plas` - plasma glucose concentration, can indicate whether tha patient suffers from a **insulin resistance**
...
- `preg` - women that have been pregnant multiple times are more likely to develop **gestational diabetes**, and therefor, type 2 diabetes later in life.
