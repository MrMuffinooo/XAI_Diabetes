...
![Centris Paribus](./img/titanicCeterisProfile01E-1.png "Centris Paribus for different models")
Figure: Shape of lines resebles the nature of the model. Dot shows value and model's prediction for the observation.

![Centris Paribus](./img/titanicCeterisProfile01D-1.png "Centris Paribus for different observations")
...
As the name implies in global explainations we take a look at variables from the perspective of whole dataset. We can check the importance of variable for the model or analyse average impact of certain values on predictions.
